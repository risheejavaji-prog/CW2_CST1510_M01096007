...
# Streamlit app UI
st.title("Groq Chatbot with Streaming ")
st.write("Choose a domain and ask me anything! Responses will stream in real-time.")
...
if user_input:
    ...
    # Display the assistant's reply as it streams
    response = ""
